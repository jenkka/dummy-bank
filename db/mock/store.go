...
// Source: github.com/jenkka/dummy-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) DeleteAccount(ctx context.Context, id int64) (db.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteEntry(ctx context.Context, id int64) (db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteTransfer(ctx context.Context, id int64) (db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTxn(ctx context.Context, params db.CreateTransferParams) (db.TransferTxnRes, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTxn", ctx, params)
	ret0, _ := ret[0].(db.TransferTxnRes)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransferTxn indicates an expected call of TransferTxn.
func (mr *MockStoreMockRecorder) TransferTxn(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferTxn", reflect.TypeOf((*MockStore)(nil).TransferTxn), ctx, params)
}
