...
// Source: github.com/jenkka/basic-bank-app/db/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/jenkka/basic-bank-app/db/sqlc"
...
func (m *MockStore) TransferTxn(ctx context.Context, params sqlc.CreateTransferParams) (sqlc.TransferTxnRes, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTxn", ctx, params)
	ret0, _ := ret[0].(sqlc.TransferTxnRes)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
